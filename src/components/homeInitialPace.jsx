import watching0 from '/images/watchingMovie1.jpg'
import anime1 from '/images/familyTime.jpg'


export default function HomeInitialPace(){
    return(
       <>
        <div className="h-[56rem] lg:h-[49rem] bg-[url(/images/poster2.jpg)] bg-black/70 bg-blend-darken bg-no-repeat bg-cover">
            <div className="relative top-[10%] font-karla text-5xl lg:text-8xl text-sky-500 w-[85%] mx-auto
             border-sky-500 p-[4%] h-[19rem] lg:h-[26rem] py-[4%] backdrop-blur bg-white/70">
             Unlimited 
             <div className="relative inline-block">
                <span className="absolute inline-block bg-green-500 w-full h-full -skew-y-3 "> </span>
                <span className="text-white animate-pulse"> Movies</span>
             </div>, TV Series, Animes and lots  <span className="inline-flex"> More<svg version="1.1" xmlns="http://www.w3.org/2000/svg" className="fill-sky-500 w-[2rem] h-[2rem] lg:w-[4rem] lg:h-[4rem] lg:ml-[3rem]" width="28" height="28" viewBox="0 0 28 28">
            ...
            <div className="flex flex-col lg:flex-row bg-green-500 h-[37rem] lg:h-[23rem] pt-[33%] lg:pt-[7%] font-barlow text-white text-xl px-[4%] items-center
            gap-[2rem] lg:gap-0 lg:justify-between inset-shadow-top">
              <p className="w-full lg:w-[40%] p-[4%] lg:p-[1%] border-3 border-white mt-[5%]">
                Download and Watch quality Product for Free in a variety of file formats for support on most devices
                <span className="inline-flex px-[0.5rem] gap-x-1.5">
                <img alt="" src="/images/document-file-mov1.png"></img>
                <img alt="" src="/images/document-file-mp4.png"></img>
                </span>
                and lots more...
              </p>
              <img alt="" className="w-[15rem] outline-3 outline-white rounded-full" src={watching0}></img>
            </div>


        </div>

        <div className="flex flex-col lg:flex-row h-[31rem] lg:h-[17rem] lg:justify-between items-center px-[4%] bg-slate-500 border-t-2 border-slate-800
        justify-center border-dashed inset-shadow-bottom space-y-[2rem]">
                <img alt="" className="w-[15rem] rounded-full outline-3 outline-slate-800" src={anime1}></img>

                <p className="text-xl text-white font-barlow w-full lg:w-[40%] border-3 border-slate-800 p-[4%] lg:p-[1%]">
                     Our vast collection is crystal clear at any screen size...There will be downloads at 
                     any desired resolution coming soon
                    <span className="inline-flex">
                     <img alt="" src="/images/k2.png"></img>
                     <img alt="" src="/images/k_plus1.png"></img>
                    </span>
                </p>
            </div>
       </>
